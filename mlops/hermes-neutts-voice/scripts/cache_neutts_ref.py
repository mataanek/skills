...
# Per‑profile reference transcript: edit this once to match your WAV
REF_TEXT = (
    "and when it's good, you can't enjoy it too much because it means that when it's bad, "
    "you're going to be devastated. So I try not to enjoy it too much, so I take it with a "
    "big grain of salt and just live my life and and focus in on my next projects"
)
...
if not REF_TEXT.strip():
    print(
        "ERROR: REF_TEXT is empty in cache_neutts_ref.py. "
        "Edit this file so REF_TEXT matches the exact transcript of your reference WAV.",
